...
WebDriver.prototype.findElement = function (locator: Locator | Selector): WebElementPromise {
    return originalWebDriverFindElement.call(this, transformLocator(locator));
}

WebDriver.prototype.findElements = function(locator: Locator | Selector): Promise<WebElement[]> {
...
WebElement.prototype.findElement = function (locator: Locator | Selector): WebElementPromise {
    return originalWebElementFindElement.call(this, transformLocator(locator));
}

WebElement.prototype.findElements = function(locator: Locator | Selector): Promise<WebElement[]> {
