...
export abstract class IContainer {
     ...
     */
    public abstract registerInstance<T>(token: ContainerToken<T>, instance: T): void;
     ...
     */
    public abstract registerSingleton<T>(tokenFrom: ContainerToken<T>, tokenTo: ContainerToken<T>): void;
