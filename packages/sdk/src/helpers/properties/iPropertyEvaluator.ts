...
export abstract class IPropertyEvaluator {
     ...
     */
    public abstract evaluate(property: KeyValue, state: IState, recursive: boolean): Promise<void>;
     ...
     * @param recursive Determines whether the evaluation should be recursive
     */
    public async next(property: KeyValue, state: IState, recursive: boolean): Promise<void> {
        if (this._next) {
     ...
     * @param recursive Determines whether the evaluation should be recursive
     */
    public async first(property: KeyValue, state: IState, recursive: boolean): Promise<void> {
